...
cluster has been identified. \# in progress
...
ratios bellow 1. OPC and Oligo could seem to be a transitionning state, however they do express multiple markers from late Oligo. Microglia + Astrocytes or Oligos do have a library size
larger than the microglia clusters, but not larger than the astrocyte or
oligo population. These populations could be microglia prunning bits of
astrocytes or oligodendrocytes.

We delete the clusters mentioned above.
...
"Microglia-Astrocyte", "Oligo-Microglia")
...
findDoubletClusters(sce, sce$clusters_named) %>% as.data.frame()
