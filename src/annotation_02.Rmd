...
sce$clusters_named <-
  factor(sce$clusters_named,
    levels = c("Astro_1", "Astro_2", "Astro_Oligo", "mOligo_1", "mOligo_2", "mOligo_3", 
"mOligo_4", "iOligo", "OPC", "pOPC",   "mNeuron_ex",  
 "mNeuron_in", "iNeurons_&_NRPs","Microglia", "Immune", "BAMs",
"Mural_cells","Endothelial", "ChP_epithelia")
  )
